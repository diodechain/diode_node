...
defmodule Xirsys.XTurn.Actions.CreatePerm do
  ...
  def process(%Xirsys.Sockets.Conn{decoded_message: %XMediaLib.Stun{attrs: attrs}} = conn) do
    Logger.debug("[XTurn] creating a permission #{inspect(conn.decoded_message)}")
